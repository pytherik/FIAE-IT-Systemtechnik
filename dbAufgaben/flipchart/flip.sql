...
INSERT INTO frage
VALUES (1, 'Wer war der Sänger von Queen?'),
       (2, 'Welches Instrument spielt Jimi Hendrix?'),
       (3, 'Wer ist der Komponist der "Jupiter"-Symphonie?'),
       (4, 'In welchem Jahrzehnt wurden die Beatles gegründet?'),
       (5, 'Welches Rockfestival wurde 1970 zum "größten Festival aller Zeiten"?'),

       (6, 'Was bedeutet das Akronym "CPU"?'),
       (7, 'Was sind Mojave, Big Sur und High Sierra?'),
       (8, 'Welches Unternehmen ist der größte Hersteller von PC-Mikroprozessoren?'),
       (9, 'Wer ist der Erfinder des World Wide Web?'),
       (10, 'Was bedeutet das Akronym "HTML"?'),

       (11, 'Wie heißt der berühmteste Roman von Franz Kafka?'),
       (12, 'Wer ist der Autor des Romans "Der Fänger im Roggen"?'),
       (13, 'Welcher Schriftsteller hat die Figur des "Sherlock Holmes" erfunden?'),
       (14, 'Wer ist der Autor des Romans "1985"?'),
       (15, 'Wer ist der Autor des Romans "Der Steppenwolf"?'),

       (16, 'Welcher Kontinent hat die meisten Länder?'),
       (17, 'Wie heißt der größte See der Welt?'),
       (18, 'In welchem Land befindet sich der Ayers Rock?'),
       (19, 'Wie heißt die Hauptstadt von Spanien?'),
       (20, 'Welche ist die größte Insel der Welt?'),

       (21, 'Wer spielt die weibliche Hauptrolle in der "Harry Potter"-Filmreihe?'),
       (22, 'Wie heißt der Schauspieler, der in "Zurück in die Zukunft" die Hauptrolle spielt?'),
       (23, 'In welchem Jahr wurde der erste James-Bond-Film veröffentlicht?'),
       (24, 'Wer spielte die Hauptrolle in dem Film "Forrest Gump"?'),
       (25, 'In welchem Jahr wurde der Film "Der Club der toten Dichter" veröffentlicht?'),

       (26, 'Was ist der größte Planet in unserem Sonnensystem?'),
       (27, 'Welcher ist der längste Fluss der Welt?'),
       (28, 'Wie nennt man das längste Gebirge der Welt?'),
       (29, 'Was ist das schnellste Landtier?'),
       (30, 'Wie heißt das größte Korallenriff der Welt?');

INSERT INTO frage_thema VALUES
                            (NULL, 1, 1),
                            (NULL, 2, 1),
                            (NULL, 3, 1),
                            (NULL, 4, 1),
...
SELECT question Frage, answer Antwort, subject Thema, is_right Richtig
FROM thema t
         JOIN frage_thema ft ON t.id = ft.thema_id
         JOIN frage f on ft.frage_id = f.id
